          ...
          {isExpanded && (
            <div className="space-y-3 rounded-lg border border-border bg-surface-2 p-4">
              ...
              <button
                ...
                className="w-full rounded-lg bg-brand px-4 py-2 font-medium text-white transition-colors hover:bg-brand-600 disabled:bg-brand-400 disabled:cursor-not-allowed inline-flex items-center justify-center gap-2"
              >
                {isSearching ? (
                  <>
        ...
        <div className="space-y-3 rounded-lg border border-border bg-surface-2 p-4">
          ...
          <div className="flex gap-2 pt-2">
            ...
            <button
              onClick={handleNext}
              disabled={isSearching}
              className="flex-1 rounded-lg bg-brand px-3 py-2 text-sm font-medium text-white transition-colors hover:bg-brand-600 disabled:bg-brand-400 disabled:cursor-not-allowed inline-flex items-center justify-center gap-2"
            >
              {isSearching ? (
                <>
